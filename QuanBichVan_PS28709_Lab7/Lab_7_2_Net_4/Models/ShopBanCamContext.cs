...
public partial class ShopBanCamContext: DbContext
{
    ...
    public ShopBanCamContext(DbContextOptions<ShopBanCamContext> options): base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) => optionsBuilder.UseSqlServer("Server=Yun; Database= ShopBanCam; Trusted_Connection=True; TrustServerCertificate=True;");
